...
3. 🟡 **Drop sets** (shipped) in the logger — ~20%-off finisher, marked, counts volume, never a PR; warm-up sets excluded from volume/PRs by type. **Supersets + warm-up-set logging UI** remain.
