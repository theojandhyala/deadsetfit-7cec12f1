...
- Next update version: `1.3`
- Next update build: `133`
...
Version 1.2 is the immutable product baseline for this update. Preserve its cinematic DEADSET
first-launch animation, staged signup and membership step, friends/nearby flows, Strength Map,
weekly maps, and notifications. Version 1.3 must add to that shipped experience; never rebuild it
from the archived 1.1 artifact.
...
Before submission, confirm both products are Ready to Submit or approved in App Store Connect and included with version 1.3. Monthly and annual pricing, duration, introductory offers and localization must match the in-app paywall. RevenueCat observes StoreKit transactions; it does not replace Apple's purchase sheet.
...
- Version 1.3 release notes matching the in-app New in 1.3 summary

Suggested release notes:

> DEADSET 1.3 introduces the interactive Strength Map: see how every working set develops each muscle area, open contributing lifts and next targets, discover equipment-matched movements, and add them directly to the right training day. Setup now captures your starting working sets one exercise at a time, the Train screen surfaces your next map priority, and native haptics make key interactions feel more responsive. This update also improves plan coverage, sharing, accessibility and small-screen layout.
...
7. Attach build 133 to version 1.3, attach both subscription products and complete export compliance and content-rights questions.
