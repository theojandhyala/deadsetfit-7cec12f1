...
also works from Get Started Free using email, Sign in with Apple, or Google. No sample files or
...
IN-APP PURCHASES
DEADSET Pro is an auto-renewing subscription sold through Apple StoreKit on iPhone. Navigate to
Profile > Upgrade - Go Pro (or any locked Pro feature). The paywall lists the Apple-provided price,
"Monthly" or "Annual" duration, renewal/cancellation disclosure, Restore Purchases, Manage
Subscription, Terms of Use and Privacy Policy before purchase. Products:
- org.deadsetfit.pro.monthly: DEADSET Pro Monthly, one month
- org.deadsetfit.pro.annual: DEADSET Pro Annual, one year
...
1. Launch DEADSET and show Get Started Free, email signup, Apple and Google options.
...
5. Open the Pro paywall; show monthly/annual Apple prices, subscription terms, restore, manage,
