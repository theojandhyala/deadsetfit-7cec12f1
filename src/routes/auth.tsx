  ...
  return (
    <div className="min-h-screen bg-grit relative overflow-hidden flex flex-col">
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse at 50% 0%, rgba(230,50,34,0.12) 0%, transparent 60%), linear-gradient(180deg, rgba(10,10,10,0) 0%, rgba(10,10,10,0.95) 70%)",
        }}
        aria-hidden="true"
      />
      ...
      <div
        ...
        style={{
          ...
          height: 300,
          borderRadius: "50%",
          background: "radial-gradient(circle, rgba(230,50,34,0.35) 0%, transparent 70%)",
          filter: "blur(60px)",
          top: "-80px",
          right: "-60px",
        }}
      ...
      <div
        ...
        style={{
          ...
          height: 220,
          borderRadius: "50%",
          background: "radial-gradient(circle, rgba(230,50,34,0.2) 0%, transparent 70%)",
          filter: "blur(50px)",
          bottom: "10%",
          left: "-60px",
        }}
      ...
      <div className="relative z-10 flex-1 flex flex-col items-center justify-center px-6 py-12">
        ...
        <div className="text-center mb-8">
          <span
            className="display font-extrabold tracking-wider text-6xl sm:text-7xl block"
            style={{ fontStyle: "italic", textShadow: "0 0 40px rgba(230,50,34,0.4)" }}
          >
            <span style={{ color: "#f5f5f0" }}>DEAD</span>
            <span style={{ color: "#e63222" }}>SET</span>
          </span>
          <p className="label-cap text-grit-dim mt-2 tracking-[0.25em]">FORGE YOUR BODY</p>
        </div>
        ...
        <div className="flex flex-wrap justify-center gap-2 mb-8 max-w-md">
          {[
            { icon: "◆", text: "TRACK PRs" },
            { icon: "▲", text: "FOLLOW PROGRAMS" },
            { icon: "◆", text: "EARN GRIT" },
            { icon: "▲", text: "RISE THE RANKS" },
          ].map((f, i) => (
            <span
              key={i}
              className="inline-flex items-center gap-1.5 px-3 py-1.5 text-[10px] label-cap"
              style={{
            ...
            >
              <span style={{ color: "#e63222" }}>{f.icon}</span>
              {f.text}
            </span>
          ))}
        </div>
        ...
        <div className="flex items-center justify-center gap-8 mb-10">
          {[
            ...
            <div key={i} className="text-center">
              <p className="display font-extrabold text-xl" style={{ color: "#e63222" }}>
                {s.n}
              </p>
