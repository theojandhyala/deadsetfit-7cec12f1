  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none fixed inset-0 overflow-hidden" aria-hidden>
        <div style={{ position: "absolute", width: 500, height: 500, borderRadius: "50%", background: "radial-gradient(circle, rgba(252,76,2,0.18) 0%, transparent 70%)", filter: "blur(80px)", top: -120, left: "50%", transform: "translateX(-50%)" }} />
        <div style={{ position: "absolute", width: 300, height: 300, borderRadius: "50%", background: "radial-gradient(circle, rgba(252,76,2,0.1) 0%, transparent 70%)", filter: "blur(60px)", bottom: "15%", right: -80 }} />
      </div>
      ...
      <div className="relative z-10 flex-1 flex flex-col items-center justify-center px-5 py-10">
        ...
        <div
          ...
          style={{ background: "rgba(28,29,33,0.95)", border: "1px solid rgba(252,76,2,0.2)", borderRadius: 20, padding: 28, backdropFilter: "blur(20px)", boxShadow: "0 0 60px rgba(252,76,2,0.06), 0 20px 60px rgba(0,0,0,0.4)" }}
        >
          ...
          {mode === "reset" && (
            <>
              ...
              <p className="text-xs mb-5" style={{ color: "#9EA3AE" }}>Choose a new password for your account.</p>
              <form onSubmit={submitNewPassword} className="space-y-3">
                <div className="relative">
                  <input
                    ...
                    style={{ background: "#111215", border: "1.5px solid #2C2D33", outline: "none" }}
                    onFocus={(e) => (e.target.style.borderColor = "#FC4C02")}
                    onBlur={(e) => (e.target.style.borderColor = "#2C2D33")}
                  />
          ...
          {mode === "forgot" && (
            <>
              ...
              <p className="text-xs mb-5" style={{ color: "#9EA3AE" }}>Enter your email and we'll send a reset link.</p>
              ...
              <button type="button" onClick={() => setMode("signin")} className="w-full mt-4 text-xs font-semibold" style={{ color: "#9EA3AE" }}>
                ← Back to sign in
              </button>
            </>
          )}
          ...
          {(mode === "signin" || mode === "signup") && (
            <>
              {/* Tab switcher */}
              <div className="flex mb-6 p-1 rounded-xl" style={{ background: "#111215" }}>
                {(["signin", "signup"] as const).map((m) => (
                  <button
                    ...
                    style={{
                      background: mode === m ? "#FC4C02" : "transparent",
              ...
              <form onSubmit={submit} className="space-y-3">
                ...
                {mode === "signin" && (
                  <div className="text-right">
                    <button type="button" onClick={() => setMode("forgot")} className="text-xs font-semibold" style={{ color: "#9EA3AE" }}>
                      Forgot password?
                    </button>
                  </div>
                )}
              ...
              <div className="flex items-center gap-3 my-5">
                <div style={{ flex: 1, height: 1, background: "#2C2D33" }} />
              ...
              <div className="space-y-2.5">
                <button
                  ...
                  style={{ background: "#ffffff", color: "#111215", border: "none" }}
                >
                  <svg width="16" height="16" viewBox="0 0 48 48" aria-hidden>
                    ...
                    <path fill="#4CAF50" d="M24 44c5.2 0 9.9-1.9 13.4-5.1l-6.2-5.2C29.4 35.5 26.8 36 24 36c-5.6 0-10.2-3.7-11.3-9H6.1c3.3 7.1 10.4 12 17.9 12z" />
                ...
                <button
                  ...
                  disabled={busy}
                  className="w-full py-3.5 flex items-center justify-center gap-3 text-sm font-semibold rounded-xl transition-all"
                  style={{ background: "#000000", color: "#ffffff", border: "1.5px solid #2C2D33" }}
                >
        ...
        <p className="mt-6 text-[10px] font-medium text-center" style={{ color: "#6B7280" }}>
          ...
          <Link to="/terms" className="underline" style={{ color: "#9EA3AE" }}>Terms</Link>
          {" "}and{" "}
          <Link to="/privacy" className="underline" style={{ color: "#9EA3AE" }}>Privacy Policy</Link>.
        </p>
      </div>
    </div>
  );
...
function SubmitButton({ busy, label }: { busy: boolean; label: string }) {
  return (
    <button
      ...
      style={{
        background: busy ? "rgba(252,76,2,0.6)" : "#FC4C02",
        color: "#ffffff",
        boxShadow: busy ? "none" : "0 4px 20px rgba(252,76,2,0.35)",
