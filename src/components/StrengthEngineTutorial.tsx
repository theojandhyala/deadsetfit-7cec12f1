        ...
        <div key={step} className="deadset-plan-reveal min-w-0">
          ...
          {step === 1 && (
            <div className="mt-3 flex items-center gap-2 text-[10px] font-black text-grit">
              <span className="rounded-md border border-white/10 bg-black/35 px-2 py-1.5">60 KG</span>
              <span>×</span>
              <span className="rounded-md border border-white/10 bg-black/35 px-2 py-1.5">10 REPS</span>
              <Check size={14} className="text-emerald-400" />
            </div>
          )}
          {step === 2 && (
            <div className="mt-3 flex items-center gap-2 text-[10px] font-black text-grit">
              <span className="text-grit-dim">60 KG</span>
              <ChevronRight size={14} className="text-accent-red" />
              <span className="rounded-md bg-accent-red px-2 py-1.5 text-black">62.5 KG NEXT</span>
            </div>
          )}
        </div>
