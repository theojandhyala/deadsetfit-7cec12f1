  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2
          id="first-week-nudge-title"
          className="display mt-1 text-3xl font-extrabold uppercase leading-none text-grit"
        >
          Make session one happen
        </h2>
        <p className="mt-3 text-sm leading-relaxed text-grit-dim">
          Your plan is ready. Log one workout and Deadset can start showing PRs, volume and
          momentum.
        </p>
        <button
          onClick={() => {
