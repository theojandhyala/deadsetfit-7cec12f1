...
export const toggleLike = ({
  ...
  data: { postId: string; reaction?: "fire" | "beast" | "respect" | "goat" };
...
export const respondDuel = ({
  data,
}: {
  data: { duelId: string; action: "accept" | "decline" | "cancel" };
...
export const updateMyLocation = ({
  ...
  data: { city: string; region?: string | null; country: string };
