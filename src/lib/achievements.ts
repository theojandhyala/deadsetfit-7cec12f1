...
const CATALOG: Definition[] = [
  // ── Consistency ─────────────────────────────────────────────
  {
    id: "first-rep",
    label: "FIRST REP",
    desc: "Finish your first session",
    icon: "🥇",
    category: "CONSISTENCY",
    rarity: "COMMON",
    target: 1,
    measure: (f) => f.sessions,
  },
  {
    id: "sessions-10",
    label: "WARMED UP",
    desc: "Finish 10 sessions",
    icon: "🔥",
    category: "CONSISTENCY",
    rarity: "COMMON",
    target: 10,
  ...
  },
  {
    id: "days-50",
    label: "FIFTY DAYS",
    desc: "Train on 50 different days",
    icon: "🗒️",
    category: "CONSISTENCY",
    rarity: "RARE",
    target: 50,
    measure: (f) => f.daysTrained,
  },
  {
    id: "days-200",
    label: "TWO HUNDRED",
    desc: "Train on 200 different days",
    icon: "📚",
    category: "CONSISTENCY",
    rarity: "EPIC",
    target: 200,
  ...
  {
    id: "sets-500",
    label: "FIVE HUNDRED SETS",
    desc: "Log 500 sets",
    icon: "📊",
    category: "TONNAGE",
    rarity: "RARE",
    target: 500,
    measure: (f) => f.totalSets,
  },
  {
    id: "sets-2500",
    label: "SET MACHINE",
  ...
  {
    id: "reps-10k",
    label: "TEN THOUSAND REPS",
    desc: "Log 10,000 reps",
    icon: "🔁",
    category: "TONNAGE",
    rarity: "EPIC",
    target: 10_000,
    measure: (f) => f.totalReps,
  },
  {
    id: "marathon-set",
    label: "MARATHON",
    desc: "40 sets in one session",
    icon: "🏃",
    category: "TONNAGE",
    rarity: "RARE",
    target: 40,
    measure: (f) => f.longestSessionSets,
  },
  ...
  },
  {
    ...
    desc: "Bench your own bodyweight",
    icon: "🛏️",
    category: "STRENGTH",
    rarity: "RARE",
    target: 100,
    measure: (f) => Math.round(f.benchRatio * 100),
  },
  {
    id: "bench-1_5",
    label: "BENCH 1.5×",
    desc: "Bench 1.5× bodyweight",
    icon: "🔱",
    category: "STRENGTH",
    rarity: "LEGENDARY",
    target: 150,
  ...
  },
  {
    id: "squat-1_5",
    label: "SQUAT 1.5×",
    desc: "Squat 1.5× bodyweight",
    icon: "🦵",
    category: "STRENGTH",
    rarity: "EPIC",
    target: 150,
    measure: (f) => Math.round(f.squatRatio * 100),
  },
  {
    id: "squat-2",
    label: "SQUAT DOUBLE",
    desc: "Squat 2× bodyweight",
    icon: "🐘",
    category: "STRENGTH",
    rarity: "LEGENDARY",
    target: 200,
  ...
  },
  {
    ...
    desc: "Deadlift 2× bodyweight",
    icon: "🪝",
    category: "STRENGTH",
    rarity: "EPIC",
    target: 200,
    measure: (f) => Math.round(f.deadliftRatio * 100),
  },
  {
    id: "deadlift-2_5",
    label: "DEADLIFT 2.5×",
    desc: "Deadlift 2.5× bodyweight",
    icon: "🗿",
    category: "STRENGTH",
    rarity: "LEGENDARY",
    target: 250,
  ...
  // ── Variety ─────────────────────────────────────────────────
  {
    id: "exercises-10",
    label: "EXPLORER",
    desc: "Train 10 different exercises",
    icon: "🧭",
    category: "VARIETY",
    rarity: "COMMON",
    target: 10,
    measure: (f) => f.distinctExercises,
  },
  {
    id: "exercises-30",
    label: "WELL ROUNDED",
    desc: "Train 30 different exercises",
    icon: "🎯",
    category: "VARIETY",
    rarity: "RARE",
    target: 30,
  ...
  },
  {
    id: "exercises-60",
    label: "ENCYCLOPEDIA",
    desc: "Train 60 different exercises",
    icon: "📖",
    category: "VARIETY",
    rarity: "EPIC",
    target: 60,
  ...
  {
    id: "muscles-all",
    label: "NOTHING SKIPPED",
    desc: "Train all 6 muscle groups",
    icon: "🧍",
    category: "VARIETY",
    rarity: "RARE",
    target: 6,
    measure: (f) => f.distinctMuscleGroups,
  },
  {
    id: "programs-1",
    label: "ARCHITECT",
    desc: "Build a training programme",
    icon: "📐",
    category: "VARIETY",
    rarity: "COMMON",
    target: 1,
    measure: (f) => f.programsBuilt,
  },
  {
    id: "programs-3",
    label: "PERIODISED",
    desc: "Build 3 training programmes",
    icon: "🗂️",
    category: "VARIETY",
    rarity: "RARE",
    target: 3,
  ...
  // ── Dedication ──────────────────────────────────────────────
  {
    id: "early-1",
    label: "SUNRISE SET",
    desc: "Train before 7am",
    icon: "🌅",
    category: "DEDICATION",
    rarity: "COMMON",
    target: 1,
    measure: (f) => f.sessionsBefore7am,
  },
  {
    id: "early-20",
    label: "DAWN PATROL",
    desc: "Train before 7am 20 times",
    icon: "🐓",
    category: "DEDICATION",
    rarity: "EPIC",
    target: 20,
  ...
  },
  {
    id: "late-1",
    label: "NIGHT SHIFT",
    desc: "Train after 9pm",
    icon: "🌙",
    category: "DEDICATION",
    rarity: "COMMON",
    target: 1,
    measure: (f) => f.sessionsAfter9pm,
  },
  {
    id: "late-20",
    label: "NOCTURNAL",
    desc: "Train after 9pm 20 times",
    icon: "🦉",
    category: "DEDICATION",
    rarity: "EPIC",
    target: 20,
  ...
  },
  {
    ...
    desc: "Train 10 weekend days",
    icon: "🛡️",
    category: "DEDICATION",
    rarity: "RARE",
    target: 10,
    measure: (f) => f.weekendSessions,
  },
  {
    id: "weekend-50",
    label: "NO DAYS OFF",
    desc: "Train 50 weekend days",
    icon: "⚔️",
    category: "DEDICATION",
    rarity: "LEGENDARY",
    target: 50,
  ...
  },
  {
    id: "checkin-1",
    label: "BEFORE",
    desc: "Take your first check-in photo",
    icon: "📸",
    category: "DEDICATION",
    rarity: "COMMON",
    target: 1,
    measure: (f) => f.checkIns,
  },
  {
    id: "checkin-10",
    label: "THE RECEIPTS",
    desc: "Take 10 check-in photos",
    icon: "🖼️",
    category: "DEDICATION",
    rarity: "RARE",
    target: 10,
  ...
  },
  {
    id: "weighin-30",
    label: "TRACKED",
    desc: "Log 30 bodyweight entries",
    icon: "⚖️",
    category: "DEDICATION",
    rarity: "RARE",
    target: 30,
    measure: (f) => f.weighIns,
  },
  {
    id: "measure-5",
    label: "TAPE MEASURE",
    desc: "Log 5 measurement sets",
    icon: "📏",
    category: "DEDICATION",
    rarity: "COMMON",
    target: 5,
    measure: (f) => f.measurements,
  },
  ...
  // ── Nutrition ───────────────────────────────────────────────
  {
    id: "food-1",
    label: "FIRST MEAL",
    desc: "Log a day of food",
    icon: "🍽️",
    category: "NUTRITION",
    rarity: "COMMON",
    target: 1,
    measure: (f) => f.daysFoodLogged,
  },
  {
    id: "food-30",
    label: "MACRO MINDED",
    desc: "Log 30 days of food",
    icon: "🥗",
    category: "NUTRITION",
    rarity: "RARE",
    target: 30,
  ...
  {
    id: "food-100",
    label: "KITCHEN DISCIPLINE",
    desc: "Log 100 days of food",
    icon: "👨‍🍳",
    category: "NUTRITION",
    rarity: "EPIC",
    target: 100,
  ...
  },
  {
    id: "protein-10",
    label: "PROTEIN HIT",
    desc: "Hit protein on 10 days",
    icon: "🥩",
    category: "NUTRITION",
    rarity: "COMMON",
    target: 10,
    measure: (f) => f.daysProteinHit,
  },
  {
    id: "protein-50",
    label: "FED TO GROW",
    desc: "Hit protein on 50 days",
    icon: "🍗",
    category: "NUTRITION",
    rarity: "EPIC",
    target: 50,
  ...
  },
  {
    id: "water-20",
    label: "HYDRATED",
    desc: "Hit your water target 20 days",
    icon: "💧",
    category: "NUTRITION",
    rarity: "RARE",
    target: 20,
    measure: (f) => f.daysWaterHit,
  },
];
