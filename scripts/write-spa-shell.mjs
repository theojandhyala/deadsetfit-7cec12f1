/**
 * Post-build: write dist/client/app-shell.html with the actual hashed asset paths.
 * app-shell.html is served by the CF ASSETS binding when SSR crashes, so React
 * boots client-side instead of showing a hard error page.
 */
...
console.log(`✓ app-shell.html → /assets/${mainJs} + /assets/${cssFile}`);
