...
check(
  ...
  (xcodeProject.match(/MARKETING_VERSION = 1\.3;/g)?.length ?? 0) >= 6 &&
    (xcodeProject.match(/CURRENT_PROJECT_VERSION = 160;/g)?.length ?? 0) >= 6 &&
    whatsNew.includes("WHATS_NEW_VERSION = 202609091"),
  "The app, activity extension and watch targets are versioned as 1.3 (160), above shipped build 152.",
);
check(
